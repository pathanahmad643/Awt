    ...
    <div className='w-screen h-full text-black'>
      ...
      <Navbar/>
        ...
        <div className='  flex justify-center items-center flex-col w-screen h-100  mt-25 mb-15 '>
          ...
          src="https://www.awtbharat.com/public/media%20(1).jpg" alt="" />
           <h1
           className='relative w-full h-15 font-extrabold text-5xl  font-sans text-center text-shadow-lg text-shadow-blue-300 '
           >Media Reports</h1>
           ...
           <div className='flex font-medium relative text-lg gap-4 bg-purple-600 w-[30%] justify-center rounded-2xl text-black '>
                ...
                <Link className='hover:text-blue-500' to='/Media'>/Media</Link>
                <Link className='text-white' to='/Reports'>Reports</Link>
           </div>
       </div>

         <div className='w-200 h-50  m-auto'>
                 <h1 className='text-6xl text-blue-700 font-bold font-sans text-center'>Mediareport</h1>
                ...
                <input type="search" placeholder='🔍 Search Events....'
                 className='shadow-2xl shadow-gray-900 w-90 h-10 px-3 ml-60 mt-5 border-none rounded-2xl  focus:ring-2 focus:ring-blue-600 outline-none bg-white text-black text-lg font-medium font-sans'/>
           </div>
